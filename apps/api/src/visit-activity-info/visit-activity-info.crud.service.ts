...
import {AsyncValidatorChain, VisitActivityInfo, VisitActivityInfoInput, User, UUID} from '@melluin/common';
...
export class VisitActivityInfoCrudService {
    ...
    public async addActivityInfo(visitId: UUID, activityInfo: VisitActivityInfoInput, requester: User): Promise<VisitActivityInfo> {
    ...
    public async getActivityInfo(visitId: UUID, requester: User): Promise<VisitActivityInfo> {

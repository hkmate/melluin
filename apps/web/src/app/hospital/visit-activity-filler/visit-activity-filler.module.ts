...
import {VisitCardModule} from '@fe/app/hospital/visit/visit-card/visit-card.module';
...
import {ContinueOtherVisitDialogComponent} from '@fe/app/hospital/visit-activity-filler/continue-other/continue-other-visit-dialog/continue-other-visit-dialog.component';
...
@NgModule({
    ...
    declarations: [
        ...
        ContinueOtherVisitDialogComponent
    ],
    providers: [
...
export class VisitActivityFillerModule {
}
